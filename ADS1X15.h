...
extern const uint16_t MUX_BY_CHANNEL[4];
...
typedef struct {
	uint16_t m_addr;		///< I2C bus device address
...
void setGain(m_i2c_dev *i2c, adsGain_t gain);
void setDataRate(m_i2c_dev *i2c, uint16_t rate);
uint16_t getDataRate(m_i2c_dev *i2c);
//
